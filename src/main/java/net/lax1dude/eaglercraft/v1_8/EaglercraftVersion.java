...
public class EaglercraftVersion {
	...
	//made lots of spaces to center it
	public static final String projectForkName = "           EaglyMC";
	//no version for now
	public static final String projectForkVersion = "";
	public static final String projectForkVendor = "the EaglyMC team";
	
	public static final String projectForkURL = "https://gitlab.com/lax1dude/eaglercraftx-1.8";
	
	//////////////////////////////////////////////////////////////////////
	
	//sorry had to remove credits :( plz forgive me (for aesthetic reasons!)
	
	public static final String projectOriginName = "EaglyMC";
	...
	public static final String mainMenuStringA = "Minecraft 1.20.1";
	public static final String mainMenuStringB = projectOriginName + " " +
			projectOriginRevision + "-" + projectOriginVersion + " eventual"; //changed " ultimate" to " eventual"
